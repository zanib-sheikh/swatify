...
></div>
  ...
  Save time, reduce costs, and focus on what matters most. Let Sawtify handle client calls, schedule appointments, and send confirmations—seamlessly and professionally.
  </p>
 ...
 <div className="w-full mt-16 md:mt-32 flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0 md:space-x-4 px-4 md:px-12">
  ...
  >
    ...
    What is Sawtify?
            ...
            <p className="text-gray-400 font-space-grotesk text-md pr-7 text-start">Sawtify is an intelligent assistant designed for streamline client interaction processes for businesses. </p>
          </div>
...
<div className="flex flex-col md:flex-row justify-between px-2 md:px-8 lg:px-8 py-10 space-y-8 md:space-y-0 md:space-x-12 mt-0 md:mt-8">
  ...
  <div className="max-w-lg md:w-[40%] lg:w-[35%] text-left mx-auto md:mx-0">
    ...
    <p className="text-gray-400">Sawtify isn’t just a call handler—it’s your all-in-one AI assistant. From pre-screening inquiries to scheduling, follow-ups, and personalized responses, Sawtify integrates seamlessly with your business systems, knowledge base, calendars, and email. It understands your business inside and out, providing clients with accurate, professional, and consistent service—saving your team time and boosting efficiency.</p>
    <button
